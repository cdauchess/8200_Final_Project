...
class ValDataNS(data.Dataset):
    def __init__(self, val_data_dir,val_filename):
        super().__init__()
        val_list = val_filename

        input_names = val_list
        gt_names = val_list #Load GT as the originial image, only for inferencing as we don't care about metrics
