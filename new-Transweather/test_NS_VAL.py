...
from val_data_functions import ValData, ValDataNS
...
inputImList = DL.SingleListImages(onlyRain=False)
...
val_data_loader = DataLoader(ValDataNS("",inputImList), batch_size=val_batch_size, shuffle=False, num_workers=8)
...
val_psnr, val_ssim = validation_val(net, val_data_loader, device, exp_name,category, save_tag=True, saveExt = "_TransW")
