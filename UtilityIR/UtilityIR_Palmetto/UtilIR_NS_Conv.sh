...
echo "Starting Cleansing, Model 1"
srun python test.py --out_dir results --testing NS_INFERENCE --model 1
echo "Draining Complete - Utility IR1"
...
echo "Starting Utility IR Validation, model 1"
srun python ./exps/det/CRN_r50_256x704_128x128_4key_CDD_UtilityIR1.py --ckpt_path ./models/CRN_r50_256x704_128x128_4key.pth -e -b 1 --gpus 1
